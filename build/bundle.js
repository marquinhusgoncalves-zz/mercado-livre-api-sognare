...
exports.fetch_users = exports.FETCH_USERS = undefined;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get('https://react-ssr-api.heroku.com/');
...
exports.default = function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouterDom.Route, { path: '/items', component: _UsersList2.default })
  );
};
...
var ItemsList = function (_Component) {
  ...
  _createClass(ItemsList, [{
    ...
    value: function renderItems() {
      return this.props.users.map(function (items) {
        return _react2.default.createElement(
          'li',
          { key: user.id },
          items.name
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { fetchItems: _actions.fetchItems })(ItemsList);
